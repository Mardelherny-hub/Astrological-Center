                ...
                <div class="col-xs-12 col-md-9 col-lg-8" style="margin-bottom: 0px;">
                  <div class="harmonic-styles astro">
                    <div class="header-section" style="margin-bottom: 10px;">
                      ...
                      <h4 style="font-size:17px;"> <b>Día y Horario:</b> Miércoles a las 18 hs. (hora Arg.)</h4>
                    ...
                    <div class="row">
                      <div class="col-xs-12 col-sm-12">
                        ...
                        <div>
                          <h4 style="font-size: 17px;">Horario de la transmisión del Curso: 18 hs. (Hora Argentina)</h4>
                            <div class="col-xs-12 col-sm-6">
                              <img styles="float: left; margin-right: 0px; width: 100%;" src="https://www.aztlan.org.ar/assets/images/home/mapamundi_online_18.jpg" alt="Image" class="img-responsive" id="mapamundiScale">
                            </div>
