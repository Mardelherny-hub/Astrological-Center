	...
	<body>
		...
		<div id="container" style="background-color: #fff;">
			...
			<div class="col-sm-12" style="padding: 0px;">
				<img src="assets/images/home-novedades/home/curso_astro_slide_3_meses.jpg" width="100%">	
			</div>
									...
									<div class="row">
										...
										<div class="col-12 col-md-6 col-lg-12">
										  ...
										  <ul class="font18" style="margin: 0px; padding-left: 16px; font-size: 16px; line-height: 26px;">
											...
											<li><b>Nivel 2</b><br>Ascendente y la Cruz Astrológica, Hemisferios y Cuadrantes, <br>los 4 elementos y los Regentes Planetarios.</li>
											<li><b>Nivel 3</b><br>Los Nodos de la Luna, Las Casas sin Planetas, <br>El Sol en las 12 Casas y la Luna en las 12 Casas.</li>
			...
			<div class="row" style="clear: both; margin: 15px 0 9px;">
				<div class="col-12">
				  <h2 class="h2sub" style="margin-bottom: 5px;font-size: 18px; padding-left: 10px;"><strong>INICIO ABRIL 2021</strong></h2>
				</div>
						...
						<div>
						   <h5 style="background-color: #F7EEF7; border-radius: 2px;padding-left: 10px;" class="col-xs-12">
								...
								<div class="row">
		                              <div class="col-md-12">
										<div>
										   <h4>Horario de la transmisión del Curso: 12 hs. (Hora Argentina)</h4>
										   <img src="http://www.aztlan.com.ar/assets/images/home/mapamundi_online_12.jpg" alt="Image" class="img-responsive" width="80%" height="80%">
								  ...
								  <div class="row" style="margin-top: 20px; margin-bottom: 30px;">
									  ...
									  <!--div class="col-xs-12 col-md-6">
										...
										<p><i>En caso de inconvenientes con Internet durante la transmisión se compartirá la grabación al finalizar.</i></p>
