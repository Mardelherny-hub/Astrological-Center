...
<head>
	...
	$asunto = 'Solicitud de Información - Curso de Astrología Mundial'; ?>
						...
						<div class="col-xs-12 col-md-9 col-lg-8" style="margin-bottom: 0px;">
							<div class="harmonic-styles astro">
								<div class="header-section" style="margin-bottom: 10px;">
									<h3>ONLINE COURSE</h3>
									<h1>WORLD ASTROLOGY</h1>
									<h2 style="font-style: italic; font-size: 18px;">Foundations and Principles by Astrologer Nicolás Nardi</h2>
									<!--h2 style="font-size: 17px;">Free drawing of your Natal Chart by Centro Astrológico Aztlan</strong><h2-->
									<h4 style="font-size:17px;"> <b>Start:</b> Tuesday, January 9th at 9:30 pm (Argentine Time).</h4>
								</div>
								...
								<div class="row" style="margin-bottom: 0px; padding-bottom: 0px;">
									...
									<div class="col-xs-12 col-md-6">
										<h4 style="font-size:16px;">This course is aimed at all lovers of this ancient wisdom seeking a deeper understanding of global and historical events.</h4>
										<h4 class="h2sub" style="margin-bottom: 5px; margin-top: 0px; font-size: 16px !important; background-color: #f7efef">AGENDA:</h4>
										<h4 style="font-size:17px">First Module</h4>
										<ul class="font18" style="margin: 0px; padding-left: 16px; font-size: 16px; line-height: 26px;">
											<li>History of World Astrology</li>
										</ul>
									</div>
								</div>

								<div style="margin: 0px 0px 15px 28px">
									<!--p style="font-weight: bold; margin-top: 0px; margin-bottom: 0">AGENDA:</p-->
									<ul class="font18" style="margin: 0px; padding-left: 16px; font-size: 16px; line-height: 26px;">
										<li>Astrological Prophecies and Prophets</li>
										<li>The Great Polar Cycle and the 12 Eras</li>
										<li>The major historical cycles from Jupiter to Pluto</li>
									</ul>
								</div>
								...
								<div style="margin-top: 0px;" class="col-xs-12 col-md-6">
									<ul class="font18" style="margin: 0px; padding-left: 0px; font-size: 16px; line-height: 26px;">
										...
										<h4 style="font-size:17px">Second Module</h4>
										<ul>
											<li>Signs of Global Transformations</li>
											<li>Practical Studies of Great Conjunctions and Stellium</li>
											<li>Individual Birth Charts and World Astrology</li>
											<li>The Planetary Annual Cycle. Solstices and Equinoxes</li>
										</ul>
								...
								<div style="margin-top: 0px;" class="col-xs-12 col-md-6">
									<ul class="font18" style="margin: 0px; padding-left: 0px; font-size: 16px; line-height: 26px;">
										...
										<h4 style="font-size:17px">Third Module</h4>
										<ul>
											<li>Transmitting and Activating Planets of Energy</li>
											<li>The Chronocrators. Jupiter and Saturn every 20 years</li>
											<li>Eclipses and their importance, historical examples</li>
											<li>Times of War and Peace, how to understand them</li>
										</ul>
									</ul>
								</div>
								...
								<div style="margin-top: 0px;" class="col-xs-12 col-md-6">
									<ul class="font18" style="margin: 0px; padding-left: 0px; font-size: 16px; line-height: 26px;">
										...
										<h4 style="font-size:17px">Fourth Module</h4>
										<ul>
											<li>Countries and Cities. Determination of their birth charts</li>
											<li>Zodiacal and Planetary Symbolism in World Astrology</li>
											<li>Astrological Houses in World Astrology</li>
											<li>Conclusions, questions, and answers</li>
										</ul>
									</ul>
								</div>
									...
									<div class="col-xs-12 col-sm-12">
										...
										<div class="col-xs-12 col-sm-12">
											<p style="font-size:16px;"><strong>Duration:</strong> 3 months (12 Classes).<br>
												<strong>Modality:</strong> 1 Class per week for 1 hour. Classes live and available for 72 hours.
											</p>

											<p style="font-size: 16px;"><strong>Includes:</strong></p>
											<ul style="font-size:15px;">
												<li>Participation in live chat for real-time Q&A.</li>
												<li>Classes remain available for 3 days for you to watch as many times as needed.</li>
											</ul>
