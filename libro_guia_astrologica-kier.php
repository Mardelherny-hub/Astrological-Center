		...
		<div id="container" style="background-color: #fff;">
			...
			<div class="row">
				<div class="col-sm-12" style="padding: 0px;">
					<img src="http://www.centroastrologico.com.ar/img/home_slider/libroslide.jpg" width="100%">	
				</div>
			</div>
						...
						<div class="row">
							<div class="col-md-8" style="left: 20px; padding-right: 40px;">
								<section class="article_section">
									<h3 style="font-size: 19px;">PRESENTAMOS NUESTRO NUEVO LIBRO</h3><br>

									<p class="h2sub" style="margin:-14px 0 !important; font-size: 26px !important; line-height: 27px!important;"><strong>Guía Práctica de Astrología</strong></p><br>

									<p style="font-size: 22px; line-height: 120%;">Por la Astróloga Florencia Santoni</p>
									<p style="font-size: 16px;
										padding: 0px;">El Centro Astrológico Aztlan presenta el libro "Guía Práctica de Astrología", escrito por la Astróloga Florencia Santoni en la Librería Kier (Santa Fé 1260): Martes 27 de Marzo a las 18hs. </p>

										<hr style="margin-top: 0px">
									<div class="page-header articulo_header" style=" border-bottom-width: 0px;
                                         padding-bottom: 0px;
                                             margin: 20px 0 20px;">
										<section>
											<div style="height: auto;max-width: 1600px; float: left; margin-right: 20px;">
												<iframe width="450" height="250" class="video-header"
												src="https://www.youtube.com/embed/TZn0t3rvh34" frameborder=”0″ allowfullscreen>
												</iframe>
											</div>
										</section>
										
										<p>He aquí, una guía sumamente práctica y esclarecedora (tanto para neófitos como para estudiantes) para adentrarse en el saber astrológico, y así aprender a leer la Carta Natal.</p>

										<p>El mayor aporte de este libro, consiste en que expone un novedoso método, que logra una síntesis entre la sabiduría milenaria de la astrología tradicional, a la que se le suman hoy los aportes del enfoque moderno de la astrología psicológica, de la cual el gran psicólogo Carl Gustav Jung fuera uno de sus precursores.</p>

										<p>¿Quién soy? ¿De dónde vengo? ¿Hacia a dónde voy? Es posible empezar a hallar respuestas de la mano de la Astrología.</p>

										<p>La Carta Natal es un mapa de la psique, que permite descubrir rasgos del carácter que aún no se han vuelto conscientes. Con su ayuda podemos llegar a conocernos mejor, y arribar a una comprensión de nuestra verdadera naturaleza en los distintos ámbitos de la vida: pareja, profesión, familia, economía y espiritualidad.</p>

										<hr>

										<!--div class="page-header articulo_header">
											<p><b>¿QUERÉS ADQUIRIR EL LIBRO?</b>
											<p>Si te interesa adquirir el libro te dejamos a continuación las distintos medios de pago. Al valor del libro se le debe sumar el costo del envío que corre por cuenta del comprador. Apenas elijas el medio de pago te informaremos el costo de envío.</p>
											<img class="visible-md visible-lg" src="img/pagos.jpg" width="100%">
											<img class="visible-xs" src="img/pagosmobile.jpg" width="100%">
										</div-->
							...
							<div class="col-md-4 side_section" style="padding-right: 0px;">
								<?php include('site/form-libro-kier.php'); ?>
								<!--p><b>TAMBIÉN ENCONTRALO EN ESTAS LIBRERÍAS:</b></p--> <br>

										<!--table border="0" width="100%" style="font-size: 16px;">
											<tr>
											    <td align="center" style="padding: 14px;"><b>"El Aleph"</b> <br> Av.Rivadavia 3972</td>
											</tr>

											<tr>
											    <td align="center" style="padding: 14px;"><b>"Librería Norte"</b> <br> Av. Las Heras 2225</td>
											</tr>

											<tr>
											    <td align="center" style="padding: 14px;"><b>"Librería Santa Fe"</b> <br> Santa Fe 2224</td>
											</tr>


											<tr>
											    <td align="center" style="padding: 14px;"><b>"Antígona"</b> <br> Av. Las Heras 2597</td>
											</tr>


											<tr>
											    <td align="center" style="padding: 14px;"><b>"Clásica y Moderna"</b> <br> Av. Callao 892</td>
											</tr>

											<tr>
											    <td align="center" style="padding: 14px;"><b>"KIER"</b> <br> Av. Santa Fe 1260</td>
											</tr>
										</table-->
