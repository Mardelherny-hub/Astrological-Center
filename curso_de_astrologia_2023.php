...
<body>
	...
	<div id="container" style="background-color: #fff;">
		...
		<div class="col-sm-12" style="padding: 0px;">
			<img src="https://centroastrologico.com.ar/assets/images/curso-astrologia-landing-2023.jpg" width="100%">
		</div>
						...
						<div class="col-xs-12 col-md-9 col-lg-8" style="margin-bottom: 0px;">
							<div class="harmonic-styles astro">
								<div class="header-section" style="margin-bottom: 10px;">
									...
									<h4 style="font-size:17px;"> <b>Start:</b> Wednesday, October 25th at 5:30 pm (Argentine Time)</h4>
									<h4 style="font-size:17px;">Free Natal Chart Drawing!</h4>
									<h4 style="font-size:17px;">2-for-1 Promotion!</h4>
								</div>
									...
									<div class="col-xs-12 col-md-6">
										<div class="iframe-global-responsive-container cancel-width">
											<div class="iframe-container">
												<iframe src="https://www.youtube.com/embed/PsMoTr4LhqE" frameborder="0" allowfullscreen></iframe>
											</div>
										</div>
									</div>
									<div class="col-xs-12 col-md-6">
										<h4 class="h2sub" style="margin-bottom: 5px; margin-top: 0px; font-size: 17px !important; background-color: #f7efef">SYLLABUS:</h4>
										<h4 style="font-size:17px">Level 1</h4>
										<ul class="font18" style="margin: 0px; padding-left: 16px; font-size: 16px; line-height: 26px;">
											<li>Signs: The Psychology and Physical Correspondence of each of the 12 zodiacal archetypes.</li>
											<li>Planets: What planets are in an Astrological sense. Their significance in the Psychological and Physical plane.</li>
										</ul>
									</div>
								</div>

								<div style="margin: 10px 0px 15px 28px">
									<!--p style="font-weight: bold; margin-top: 0px; margin-bottom: 0">SYLLABUS:</p-->
									<ul class="font18" style="margin: 0px; padding-left: 16px; font-size: 16px; line-height: 26px;">
										<li>Houses: Which fields of experience stand out in our Destiny and which ones we can make more conscious.</li>
										<li>Aspects: How Harmonious and Tense relationships work between different aspects of our Personality and Life situations.</li>
									</ul>
								</div>
								...
								<div style="margin-top: 0px;" class="col-xs-12 col-md-6">
									<ul class="font18" style="margin: 0px; padding-left: 0px; font-size: 16px; line-height: 26px;">
										<h4 style="font-size:17px">Level 2</h4>
										<ul>
											<li>The Ascendant and the Astrological Cross.</li>
											<li>The 4 Elements.</li>
											<li>Hemispheres and Quadrants.</li>
											<li>Planetary Rulers.</li>
										</ul>
										<!--li>How Harmonious and Tense relationships work between different aspects of our Personality and Life situations.</li-->
									</ul>
								</div>
								...
								<div style="margin-top: 0px;" class="col-xs-12 col-md-6">
									<ul class="font18" style="margin: 0px; padding-left: 0px; font-size: 16px; line-height: 26px;">
										...
										<h4 style="font-size:17px">Level 3</h4>
										<ul>
											<li>The Moon Nodes.</li>
											<li>Houses without Planets.</li>
											<li>The Sun in the 12 Houses.</li>
											<li>The Moon in the 12 Houses.</li>
										</ul>
									</ul>
								</div>
								<hr>
									...
									<div class="col-xs-12 col-sm-12">
										<div class="col-xs-12 col-sm-12">
											<p style="font-size:16px;"><strong>Duration:</strong> 3 months (12 Classes).<br>
												<strong>Mode:</strong> 1 Class per week, 1 hour each. Live classes available for 72 hours.
											</p>
