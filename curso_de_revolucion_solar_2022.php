                ...
                <div class="col-xs-12 col-md-9 col-lg-8" style="margin-bottom: 0px;">
                  <div class="harmonic-styles astro">
                    <div class="header-section" style="margin-bottom: 10px;">
                      ...
                      <h4 style="font-size:17px;"> <b>Inicio:</b> Lunes 4 de Julio a las 12 hs. (hora Arg.)</h4>
                    </div>
                    ...
                    <div class="row">
                      <div class="col-xs-12 col-sm-12">
                        ...
                        <div>
                          <h4 style="font-size: 17px; padding-top: 20px;">Horario de la transmisión del Curso: 12 hs. (Hora Argentina)</h4>
                            <div class="col-xs-12 col-sm-6">
                              <img styles="float: left; margin-right: 0px; width: 100%;" src="https://www.aztlan.org.ar/assets/images/home/mapamundi_online_12.jpg" alt="Image" class="img-responsive" id="mapamundiScale">
                            </div>
