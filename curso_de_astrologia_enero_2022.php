	...
	<body>
		...
		<div id="container" style="background-color: #fff;">
			...
			<div class="col-sm-12" style="padding: 0px;">
				<img src="https://centroastrologico.com.ar/assets/images/curso-astrologia-2022.jpg" width="100%">	
			</div>
                ...
                <div class="col-xs-12 col-md-9 col-lg-8" style="margin-bottom: 0px;">
                  <div class="harmonic-styles astro">
                    <div class="header-section" style="margin-bottom: 10px;">
                      ...
                      <!--h4 style="font-size:17px;"> <b>Inicio:</b> Viernes 1 de Abril a las 12:30 hs. (hora Arg.)</h4-->
                      ...
                      <div class="col-xs-12 col-md-6">
                        <div class="iframe-global-responsive-container cancel-width">
                          <div class="iframe-container">
                            <iframe src="https://www.youtube.com/embed/PoP5G9csSNA" frameborder="0" allowfullscreen></iframe>
                          </div>
                        </div>
                      </div>
                      <div class="col-xs-12 col-md-6">
                        <h4 class="h2sub" style="margin-bottom: 5px; margin-top: 0px; font-size: 17px !important; background-color: #f7efef">TEMARIO:</h4>
                          <ul class="font18" style="margin: 0px; padding-left: 16px; font-size: 16px; line-height: 26px;">
                            <li><b>Nivel 1</b><br>Los 12 Signos, los 10 Planetas, las 12 Casas y los Aspectos.</li>
                            <li><b>Nivel 2</b><br>El Ascendente y la Cruz Astrológica, Hemisferios y Cuadrantes, los 4 Elementos y los Regentes Planetarios.</li>
                            <li><b>Nivel 3</b><br>Los Nodos de la Luna, Las Casas sin Planetas, El Sol en las 12 Casas y la Luna en las 12 Casas.</li>
                    ...
                    <div class="row">
                      <div class="col-xs-12 col-sm-12">
                        ...
                        <div>
                          <h4 style="font-size: 17px;">Horario de la transmisión del Curso: 12:30 hs. (Hora Argentina)</h4>
