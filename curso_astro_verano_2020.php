				...
				<section class="main_section">
					<div class="container-fluid">
                      ...
                      <div class="video-container">
                        ...
                        <iframe width="565" height="300" src="https://www.youtube.com/embed/Y-GuV9McBoc" frameborder="0" gesture="media" allow="encrypted-media" allowfullscreen></iframe>
                        </div>
                  	  </div>
						<br>
						...
						<p style="font-size: 16px; margin-bottom: 0; margin-top: -15px"><strong>INICIO: ENERO.</strong><br>Turno Tarde:</p>
						<ul style="margin-bottom: 10px; list-style-position: inside;">
							<li style="font-size: 15px;margin-bottom: 10px;">Miércoles 15 de Enero a las 19 hs.</li>
						</ul>
						<!--br>
						<p style="font-size: 16px; margin-bottom: 0;">Turno tarde:</p>
						<ul style="margin-bottom: 10px; list-style-position: inside;">
						...
						<p style="font-size: 15px; margin-bottom: 0;">
							<strong>Precio: </strong>$3500.</p><br><br>
