...
<head>
	...
	$asunto = 'Solicitud de Información - Curso de Direcciones y Progresiones'; ?>
...
<body>
	...
	<div id="container" style="background-color: #fff;">
		...
		<div class="col-sm-12" style="padding: 0px;">
			<img src="https://centroastrologico.com.ar/assets/images/curso-progresiones-landing.jpg" width="100%">
		</div>
						...
						<div class="col-xs-12 col-md-9 col-lg-8" style="margin-bottom: 0px;">
							<div class="harmonic-styles astro">
								<div class="header-section" style="margin-bottom: 10px;">
									<h3>ONLINE COURSE</h3>
									<h1>DIRECTIONS AND PROGRESSIONS IN ASTROLOGY</h1>
									<!--h2 style="font-size: 17px;">Free drawing of your Natal Chart made by Centro Astrológico Aztlan</h2-->
									<h4 style="font-size:17px;"><b>Start:</b> Thursday, November 30th at 12:30 pm (Argentine Time)</h4>
									<h4 style="font-size:17px;">Promotion 2x1!</h4>
									<h4 style="font-size: 15px;"><b>Who is this course for?</b></br>For individuals familiar with the basics of astrological language (planets, signs, houses, and aspects) and interested in a serious and bold study of the future.</h4>
								</div>
								<!-- Content -->
									...
									<div class="col-xs-12 col-md-6">
										<div class="iframe-global-responsive-container cancel-width">
											<div class="iframe-container">
												<iframe src="https://www.youtube.com/embed/NVtirC6pxR8" frameborder="0" allowfullscreen></iframe>
											</div>
										</div>
									</div>
									<div class="col-xs-12 col-md-6">
										<h4 class="h2sub" style="margin-bottom: 5px; margin-top: 0px; font-size: 17px !important; background-color: #f7efef">AGENDA:</h4>
										<h4 style="font-size:17px">Level 1 (4 Classes)</h4>
										<ul class="font18" style="margin: 0px; padding-left: 16px; font-size: 16px; line-height: 26px;">
											<li>Astronomical bases of astrological calculations for directions. Latitude, Longitude, Time Arc.</li>
											<li>Example of calculating a Natal Chart necessary for direction calculations.</li>
										</ul>
									</div>
								</div>
								<div style="margin: 10px 0px 15px 28px">
									<ul class="font18" style="margin: 0px; padding-left: 16px; font-size: 16px; line-height: 26px;">
										<li>The psycho-philosophical difference between Transits, Progressions, and Directions. The internal and the external.</li>
										<li>Determinism and Free Will seen through the forecasts of what will happen.</li>
									</ul>
								</div>
								<div style="margin-top: 0px;" class="col-xs-12 col-md-6">
									<ul class="font18" style="margin: 0px; padding-left: 0px; font-size: 16px; line-height: 26px;">
										<h4 style="font-size:17px">Level 2 (4 Classes)</h4>
										<ul>
											<li>Secondary Progressions. 1 day equals 1 year. Example of calculation.</li>
											<li>The Cross and houses in Secondary Progressions.</li>
											<li>The planets in order of importance and their significance.</li>
											<li>Key points for analyzing the progressed chart over the natal chart.</li>
										</ul>
										<!--li>Harmonious and tense relationships between different aspects of our Personality and Life situations.</li-->
									</ul>
								</div>
								<div style="margin-top: 0px;" class="col-xs-12 col-md-6">
									<ul class="font18" style="margin: 0px; padding-left: 0px; font-size: 16px; line-height: 26px;">
										<h4 style="font-size:17px">Level 3 (4 Classes)</h4>
										<ul>
											<li>The 60-year Cycle as a harmonic. The meaning of change every 5 years and life stages. 6th by year Directions.</li>
											<li>The 4 phases of the 60-year cycle. The Crises represented by these 4 phases.</li>
											<li>Symbolic Directions of 1st equals 1 year of life. Harmony with Secondary Progressions of the Cross.</li>
											<li>Study charts of 1st and 6th by year directions. When will an event occur?</li>
										</ul>
									</ul>
								</div>
								<div style="margin-top: 0px;" class="col-xs-12 col-md-6">
									<ul class="font18" style="margin: 0px; padding-left: 0px; font-size: 16px; line-height: 26px;">
										<h4 style="font-size:17px">Level 4 (4 Classes)</h4>
										<ul>
											<li>Primary Directions. The complexity of their calculation, meaning, and importance.</li>
											<li>Ptolemy and his influence on the study of Directions.</li>
											<li>Review of calculations for all directions and use of ephemerides.</li>
											<li>Final questions and answers.</li>
										</ul>
									</ul>
								</div>
								<div class="row">
									<div class="col-xs-12 col-sm-12">
										<div class="col-xs-12 col-sm-12"><br><br>
											<p style="font-size:16px;"><strong>Duration:</strong> 4 months (16 Classes).<br>
												<strong>Mode:</strong> 1 Class per week for 1 hour. Live classes and available for 72 hrs.
											</p>
											<p style="font-size: 16px;"><strong>Includes:</strong></p>
											<ul style="font-size:15px;">
												<li>Participation in the live chat for immediate Q&A.</li>
												<li>Classes remain available for 3 days for review purposes.</li>
											</ul><br>
										</div>
										<div class="col-xs-12 col-sm-12">
										</div>
										<!--    <p><strong>Price:</strong> <s>$70 USD</s> / Now: $25 USD
                <i><b>Special Discount!</b></i>
                <br>(Inquire for pricing in Argentina)</p> -->
									</div>
									<!-- Video Companion -->
