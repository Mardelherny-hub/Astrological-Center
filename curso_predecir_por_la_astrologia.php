...
<html lang="es">
	<head>
		<?php include('site/head.php'); $asunto = 'Solicitud de Información - Curso Predecir por la Astrologia'; ?>
	...
	<body>
		...
		<div id="container" style="background-color: #fff;">
			...
			<div class="col-sm-12" style="padding: 0px;">
				<img src="https://centroastrologico.com.ar/assets/images/predecir-astrologia-landing.jpg" width="100%">	
			</div>
                ...
                <div class="col-xs-12 col-md-9 col-lg-8" style="margin-bottom: 0px;">
                  <div class="harmonic-styles astro">
                    <div class="header-section" style="margin-bottom: 10px;">
                      ...
                      <h1>PREDECIR POR LA ASTROLOGÍA</h1>
                      <h4 style="font-style: italic; font-size: 17px;">Tránsitos Planetarios, Karma y Libre Albedrio</h4>

                      <!--h2 style="font-size: 17px;">De regalo el dibujo de tu Carta Natal hecha por el Centro Astrológico Aztlan</strong><h2-->
                      <h4 style="font-size:17px;"> <b>Día y Horario:</b> Martes a las 12:30 hs. (Hora Arg.)</h4>
                    ...
                    <!-- Contenido -->
                      ...
                      <div class="col-xs-12 col-md-6">
                        <div class="iframe-global-responsive-container cancel-width">
                          <div class="iframe-container">
                            <iframe src="https://www.youtube.com/embed/R8kstG-35EY" frameborder="0" allowfullscreen></iframe>
                          </div>
                        </div>
                      </div>
                      <div class="col-xs-12 col-md-6">
                        <h4 class="h2sub" style="margin-bottom: 5px; margin-top: 0px; font-size: 17px !important; background-color: #f7efef">TEMARIO:</h4>
                        	<h4 style="font-size:17px">Ciclos Planetarios como Arquetipos estructuradores de lo manifiesto. 
													</h4>
													<h4 style="font-size:17px">Ciclos de Planetas Personales o Menores</h4>
													                        <ul class="font18" style="margin: 0px; padding-left: 16px; font-size: 16px; line-height: 26px;">
                          <li>Sol-Luna. Las Luminarias. Lunaciones, Nueva, Llena y Cuartos. Ciclos de Planetas Rápidos de Mercurio a Marte.</li>
                          <li>La Transmisión de Energía del planeta natal radical al de tránsito. 
</li>
                        </ul>
                      </div>
                    </div>
                      ...
                      <div style="margin-top: 10px;" class="col-xs-12 col-md-6">
                          <ul class="font18" style="margin: 0px; padding-left: 0px; font-size: 16px; line-height: 26px;">
                            ...
                            <h4 style="font-size:17px">Ciclos de los Cronocratores o Marcadores del Tiempo</h4>
                            <ul>
                            <li>Júpiter. Los períodos de Expansión y Suerte.  
</li>
                            <li>Saturno. La manifestación del Karma en sus dos fases, positiva y negativa.
</li>
                            </ul>
                      ...
                      <div style="margin-top: 0px;" class="col-xs-12 col-md-6">
                          <ul class="font18" style="margin-top: 15px; padding-left: 0px; font-size: 16px; line-height: 26px;">
                            
                            <h4 style="font-size:17px">Ciclos de Planetas Transpersonales – Más Allá del Ego</h4>
                            <ul>
                            <li>Urano. El Aprendizaje y la superación de las Crisis.  
</li>
                            <li>Neptuno. El Gran disolvente universal. La esencia del Alma. </li>
                            <li>Plutón. Muerte, Renacimiento y Transformación. 
</li>
                            </ul>
                        </ul>
                      </div>
                          ...
                          <ul class="font18" style="margin: 0px; padding-left: 0px; font-size: 16px; line-height: 26px;">
                            ...
                            <h4 style="font-size:17px">Ciclos de Eclipse sobre la Carta Natal 
</h4>
                            <ul>
                            <li>Eclipses Totales y Parciales.</li>
                            <li>Todas las Herramientas de la Predicción del repertorio del Astrólogo.  
</li>
                            </ul>
                        </ul>
                      </div>
                    ...
                    <div class="row">
                      <div class="col-xs-12 col-sm-12">
                        ...
                        <div class="col-xs-12 col-sm-12">
                          ...
                          <p style="font-size:16px;"><strong>Duración:</strong> 10 clases.<br>
                          ...
                          <ul style="font-size:15px;">
                            ...
                            <li>Participación en el chat en vivo para que respondamos tus dudas sobre los temas expuestos.</li>
                            <li>Material de apuntes en PDF.</li>
                            <li>Las clases quedan activas los 3 días siguientes para que las puedas ver las veces que necesites. (En caso de inconvenientes con el servidor de Internet durante la transmisión se compartirá la grabación al finalizar)</li>
                          </ul>
