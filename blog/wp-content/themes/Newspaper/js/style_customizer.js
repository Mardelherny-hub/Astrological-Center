...
jQuery().ready(function() {
    ...
    jQuery('.td-set-color').click(function(){
        ...
        jQuery('.td-theme-color-active').removeClass('td-theme-color-active');
        jQuery(this).addClass('td-theme-color-active');
    ...
    jQuery('.td-customizer-change-layout').click(function(){
        ...
        if (jQuery(this).data('cur-layout') == 'BOXED') {
            ...
            jQuery(this).data('cur-layout', 'FULL WIDTH');
            ...
            jQuery('.td-customizer-change-layout span').text('FULL WIDTH');
    ...
    jQuery('.td-bg-changer').click(function(){
        ...
        jQuery('.td-bg-changer-active').removeClass('td-bg-changer-active');
        jQuery(this).addClass('td-bg-changer-active');
    });


    /**
     * handles demo different styles
     */
    jQuery('.td-set-theme-style-link').click(function(event){
        event.preventDefault();
        var data_link_style = jQuery(this).data('value');

        //delete cookie; load default
        if(data_link_style == 'default') {
            td_set_cookies_life(["td-cookie-demo-theme-options", data_link_style, 0]);
            location.reload();
        } else {
            //set the cookie; load deferent theme styles
            if(typeof data_link_style != 'undefined') {
                td_set_cookies_life(["td-cookie-demo-theme-options", data_link_style, (10*60*1000)]);//10minutes
                location.reload();
            }
        }
