...
class td_login_widget extends WP_Widget {
    ...
    function widget($args, $instance) {
        ...
        if ( is_user_logged_in() ) {
            ...
            echo '
            <ul class="top-header-menu td_ul_login"><li class="menu-item"><a class="popup-with-form menu-item" href="#login-form" >' . __td("Log In") . '</a><span class="td-sp td-sp-ico-login td_sp_login_ico_style"></span></li></ul>
