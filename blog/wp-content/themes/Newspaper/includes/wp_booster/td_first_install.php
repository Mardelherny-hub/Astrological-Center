...
function td_on_theme_activate($oldname, $oldtheme=false) {
    ...
    (
        'homepage_3256' => Array (
            'name' => 'Homepage',
            'template' => '[vc_row el_position="first last"][vc_column][td_slide_big category_id="98" limit="12" hide_title="hide_title" el_position="first"][td_block2 limit="3" custom_title="DON\'T MISS" ajax_pagination="next_prev" sort="popular"][/vc_column][/vc_row]'
        ),
