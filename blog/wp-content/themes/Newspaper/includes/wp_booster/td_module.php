...
//            $buffy .= '</div>';
    ...
    function get_image($thumbType, $image_link = '', $image_excerpt = '') {
        ...
        if ($this->post_has_thumb or ($featured_image_placeholder == 'show_placeholder' and !is_single())) {
    ...
    function get_excerpt($lenght = 25, $show_shortcodes = '') {
        ...
        $buffy = '';
        //print_r($this->post);
        $buffy .= td_util::excerpt($this->post->post_content, $lenght, $show_shortcodes);
        return $buffy;
    }
}
