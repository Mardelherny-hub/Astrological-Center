            ...
            switch ($array_field['type']) {
                case 'dropdown':
                    ...
                    $buffer_field .=  '<span class="td_custom_label" >' . $array_field['heading'] . ' </span>
                        <select class="' . $array_field['class'] . '" style="width: 200px;" name="' . $this->mb->get_the_name() . '">';
                ...
                default:
                    ...
                    $buffer_field .=  '<span class="td_custom_label">' . $array_field['heading'] . ' </span>
                    <input type="text" class="' . $array_field['class'] . '" style="width: 200px;" name="' . $this->mb->get_the_name() . '" value="' . $value_input . '" />';
