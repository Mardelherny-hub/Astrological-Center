...
<html lang="es">
	<head>
		<?php include('site/head.php'); $asunto = 'Solicitud de Información - Curso de Revolución Solar'; ?>
	...
	<body>
		...
		<div id="container" style="background-color: #fff;">
			...
			<div class="col-sm-12" style="padding: 0px;">
				<img src="https://aztlan.org.ar/images/eventos/landing/3804.jpg" width="100%">	
			</div>
                ...
                <div class="col-xs-12 col-md-9 col-lg-8" style="margin-bottom: 0px;">
                  <div class="harmonic-styles astro">
                    <div class="header-section" style="margin-bottom: 10px;">
                      ...
                      <h1 style="line-height:30px">REVOLUCIÓN SOLAR</h1>
                      <h2 style="font-size: 17px; margin-top:2px;">Y otras técnicas de previsión</strong><h2>

                      <!--h2 style="font-size: 17px;">De regalo el dibujo de tu Carta Natal hecha por el Centro Astrológico Aztlan</strong><h2-->
                      <h4 style="font-size:17px;"> <b>Inicio:</b> Lunes 17 de Enero a las 12:30 hs. (hora Arg.)</h4>
                    </div>
                      ...
                      <div class="col-xs-12 col-md-6">
                        <div class="iframe-global-responsive-container cancel-width">
                          <div class="iframe-container">
                            <iframe src="https://www.youtube.com/embed/gleYU-3ITu0" frameborder="0" allowfullscreen></iframe>
                          </div>
                        </div>
                      </div>
                      <div class="col-xs-12 col-md-6">
                        <h4 class="h2sub" style="margin-bottom: 5px; margin-top: 0px; font-size: 17px !important; background-color: #f7efef">TEMARIO:</h4>
                          ...
                          <ul class="font18" style="margin: 0px; padding-left: 16px; font-size: 16px; line-height: 26px;">
                            <li>Qué es la Revolución Solar y cómo se determina</li>
                            <li>Alcances de la revolución solar</li>
                            <li>Claves de Interpretación</li>
                            <li>Errores más comunes</li>
                            <li>Los puntos sensibles de la carta y de la revolución</li>
                    ...
                    <div style="margin: 0px 0px 15px 0px">
                        ...
                        <ul class="font18" style="margin: 0px; padding-left: 16px; font-size: 16px; line-height: 26px;">
                          <li>Los 12 signos Ascendentes y su Regente</li>
                          <li>El Signo Anual del Medio Cielo y su regente.</li> 
                            <li>El Sol y la Luna de la Revolución solar</li>
                            <li>Ejemplos de Revoluciones Solares que cambiaron vidas.</li>
                        </ul>
                      </div>
                      ...
                      <div style="margin-top: 0px;" class="col-xs-12 col-md-6">
                          <ul class="font18" style="margin: 0px; padding-left: 0px; font-size: 16px; line-height: 26px;">
                            ...
                            <h4 style="font-size:17px">Segundo Módulo</h4>
                            <ul>
                            <li>Ubicar los principales tránsitos del año</li>
                            <li>La superposición de las Casas</li>
                            <li>Los planetas en la Revolución Solar: Mercurio, Venus, Marte, Jupiter.</li>
                            <li>La visión de conjunto</li>
                            <li>Los aspectos en las Revolución Solar.</li>
                            <li>Identificar los puntos débiles y fuertes</li>
                            <li>El Factor Edad y los Ciclos planetarios más importantes</li>
                      ...
                      <div style="margin-top: 0px;" class="col-xs-12 col-md-6">
                          <ul class="font18" style="margin: 0px; padding-left: 0px; font-size: 16px; line-height: 26px;">
                            ...
                            <h4 style="font-size:17px">Tercer Módulo</h4>
                            <ul>
                            <li>Determinación de acontecimientos en la Revolución Solar.</li>
                            <li>Los ciclos de 4 y 12 años</li>
                            <li>El movimiento de la Cruz Anual como determinante del proceso bio-psíquico.</li>
                            <li>La Consulta al Astrólogo: posibilidades y limitantes a la hora de pronosticar</li>
                            <li>30 Puntos Clave de los Sabios Antiguos y Modernos en la Interpretación.</li>
                            <li>Las direcciones de 6 grados por año</li>
                            <li>La Luna progresada por signos y casas</li>
                            <li>Ejemplos notables</li>
                            </ul>
                            <!--li>Cómo son las relaciones Armónicas y tensas entre los diferentes aspectos de nuestra Personalidad y situaciones de la Vida.</li-->
                        </ul>
                    ...
                    <div class="row">
                      <div class="col-xs-12 col-sm-12">
                        ...
                        <div>
                          <h4 style="font-size: 17px; padding-top: 20px;">Horario de la transmisión del Curso: 12:30 hs. (Hora Argentina)</h4>
                            <div class="col-xs-12 col-sm-6">
                              <img styles="float: left; margin-right: 0px; width: 100%;" src="https://www.aztlan.org.ar/assets/images/home/mapamundi_online_12_30.jpg" alt="Image" class="img-responsive" id="mapamundiScale">
                            </div>
                        ...
                        <div class="col-xs-12 col-sm-6">
                          <p style="margin-top: 2px; font-size: 16px;"><b>Una vez que hayas realizado la reserva te daremos la hora exacta del mismo en tu localidad.</b></p>
                          ...
                          <p style="font-size:16px;"><strong>Duración:</strong> 3 meses (12 Clases).<br>
                          ...
                          <ul style="font-size:15px;">
                            ...
                            <li>Apuntes que les enviamos con cada clase.</li>
                            <li>Participación en el chat en vivo para que respondamos todas tus preguntas en el momento.</li>
                            <li>Las clases quedan disponibles los 3 días siguientes para que las puedas ver las veces que necesites.</li>
                          </ul>
                        </div>
