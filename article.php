...
<head>
	...
	if ($_GET['article'] == 'que-es-el-signo-ascendente') {
		echo '<meta property="og:url"            content="/article.php?article=que-es-el-signo-ascendente" />';
		...
		echo '<meta property="og:image"              content="/img/articles_miniatures/que-es-el-signo-ascendente.jpg" />';
	}
	?>
</head>
					...
					<div class="row">
						<div class="col-md-9">
							...
							if ($article_exists == true) {
								print('<div class="fb-comments" data-href="/articles/' . $article_variable . '.php" data-width="100%" data-numposts="10"></div>');
							}
							?>
						</div>
						<div class="col-md-3 side_section">
							<ul class="destacados">
								...
								<a href="article.php?article=planetas-retrogrados">
									<li>
										<p>What Happens If I Have Many Retrogrades in<br />My Natal Chart?</p>
									</li>
								</a>
								...
								<a href="article.php?article=ascendente-cancer-en-la-revolucion-solar">
									<li>
										<p>Cancer Ascendant in Solar<br />Revolution</p>
									</li>
								</a>
