...
<html lang="es">
	<head>
		<?php include('site/head.php'); $asunto = 'Solicitud de Información - Curso de Astrología - GADS - Estados Unidos - Imagen'; ?>
	...
	<body>
		...
		<div id="container" style="background-color: #fff;">
			...
			<div class="col-sm-12" style="padding: 0px;">
				<img src="https://centroastrologico.com.ar/assets/images/curso-astrologia-regular-2023.jpg" width="100%">	
			</div>
                ...
                <div class="col-xs-12 col-md-9 col-lg-8" style="margin-bottom: 0px;">
                  <div class="harmonic-styles astro">
                    <div class="header-section" style="margin-bottom: 10px;">
                      ...
                      <h4 style="font-size:17px;"> <b>Inicio:</b> Miércoles 2 de Agosto a las 6 pm. (Hora Arg.)</h4>
                    ...
                    <!-- Contenido -->
                      ...
                      <div class="col-xs-12 col-md-6">
                        <h4 class="h2sub" style="margin-bottom: 5px; margin-top: 0px; font-size: 17px !important; background-color: #f7efef">TEMARIO:</h4>
                        	<h4 style="font-size:17px">Nivel 1</h4>
                          <ul class="font18" style="margin: 0px; padding-left: 16px; font-size: 16px; line-height: 26px;">
                            <li>Signos: La Psicología y la Correspondencia Física de cada uno de los 12 arquetipos zodiacales.</li>
                            <li>Planetas: Qué son los planetas en sentido Astrológico. Su significado en el plano Psicológico y Físico.</li>
                     ...
                     <div style="margin: 10px 0px 15px 28px">
                        ...
                        <ul class="font18" style="margin: 0px; padding-left: 16px; font-size: 16px; line-height: 26px;">
                          <li>Casas: Qué campos de la experiencia se destacan en nuestro Destino y cuáles podemos hacer más consciente.</li>
                          <li>Aspectos: Cómo son las relaciones Armónicas y tensas entre los diferentes aspectos de nuestra Personalidad y situaciones de la Vida.</li>
                      ...
                      <div style="margin-top: 0px;" class="col-xs-12 col-md-6">
                          <ul class="font18" style="margin: 0px; padding-left: 0px; font-size: 16px; line-height: 26px;">
                            ...
                            <h4 style="font-size:17px">Nivel 2</h4>
                            <ul>
                            <li>El Ascendente y la Cruz Astrológica.</li>
                            <li>Los 4 Elementos.</li>
                            <li>Hemisferios y Cuadrantes.</li>
                            <li>Los Regentes Planetarios.</li>
                            </ul>
                      ...
                      <div style="margin-top: 0px;" class="col-xs-12 col-md-6">
                          <ul class="font18" style="margin: 0px; padding-left: 0px; font-size: 16px; line-height: 26px;">
                            ...
                            <h4 style="font-size:17px">Nivel 3</h4>
                            <ul>
                            <li>Los Nodos de la Luna.</li>
                            <li>Las Casas sin Planetas.</li>
                            <li>El Sol en las 12 Casas.</li>
                            <li>La Luna en las 12 Casas.</li>
                            </ul>
                        </ul>
                      </div>
