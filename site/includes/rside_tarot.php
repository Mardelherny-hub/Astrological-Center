<div class="rside-blog" id="cajaform" style="margin-bottom: 15px;">
	<div class="contacto">
                <div>
                  <form id="contact" action="contact_tarot.php" method="post">
...
<div class="rside-blog" style="margin-bottom: 15px;">
	<h6>VIDEOS</h6>
	<iframe style="margin-bottom: 15px" class="img-responsive"  width="300" height="169" src="https://www.youtube.com/embed/BTUa3D7PmuE" frameborder="0" allowfullscreen></iframe>
	<iframe style="margin-bottom: 15px" class="img-responsive"  width="300" height="169" src="https://www.youtube.com/embed/2lJjiZ5UVBY" frameborder="0" allowfullscreen></iframe>
