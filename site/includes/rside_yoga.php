<div class="rside-blog" id="cajaform" style="margin-bottom: 15px;">
	  ...
	  <div class="contacto">
                <div>
                  <form id="contact" action="contacto_taller_yoga.php" method="post">
...
<div class="rside-blog" style="margin-bottom: 15px;">
	...
	<iframe style="margin-bottom: 15px" class="img-responsive"  width="300" height="169" src="https://www.youtube.com/embed/klylUUEd_bc" frameborder="0" allowfullscreen></iframe>
	<iframe style="margin-bottom: 15px" class="img-responsive"  width="300" height="169" src="https://www.youtube.com/embed/3IHisX9bv84" frameborder="0" allowfullscreen></iframe>
