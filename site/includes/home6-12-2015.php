...
<div class="row" style="width: 100%;">
	 	 	<a title="Taller de Verano 2016" target='blank' href="http://www.centroastrologico.com.ar/talleres-de-astrologia.html" style="margin:0 auto;"><img src="site/images/home/bannertaller2016_astro.gif" margin:0 auto;" /></a>
	 	 </div>
...
foreach ($eventos as $evento){	
	...
	echo '<span style="display: block; font-size:15px;margin-bottom:5px;margin-top:20px;">Reservá tu lugar <a target="blank" href="http://www.aztlan.org.ar/pages/'.$url.'/?c='.$evento->idEvento.'/3/7">aquí</a></span>';
