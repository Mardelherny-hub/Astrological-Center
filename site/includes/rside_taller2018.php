<div class="rside-blog" id="cajaform" style="margin-bottom: 15px; background-color: #3277AE; border: none;">
	...
	<div class="contacto">
                <div>
                  <form id="contact" action="contacto_taller2018.php" method="post">
                    ...
                    <fieldset>
					    <select id="reserv" name="dia" style="font-size: 15px; width: 100%;  height: 35px !important; color: #757575;">
                        <option value="" selected="selected">- Seleccioná el día y horario -</option>
                        <option value="Martes 2/01 - 11:30 hs">Martes 2/01 - 11 hs</option>
                        <option value="Martes 2/01 - 19:30 hs">Martes 2/01 - 19 hs</option>
                        <option value="Miercoles 3/01 - 11:30 hs">Miércoles 3/01 - 11 hs</option>
                        <option value="Miercoles 3/01 - 18:30 hs">Miércoles 3/01 - 18 hs</option>
                        <option value="Jueves 4/01 - 11:30 hs">Jueves 4/01 - 11 hs</option>
                        <option value="Jueves 4/01 - 19:30 hs">Jueves 4/01 - 19 hs</option>
                        <option value="Viernes 5/01 - 11:30 hs">Viernes 5/01 - 11 hs</option>
                        <option value="Sabado 5/01 - 19:30 hs">Sábado 5/01 - 19 hs</option>
                      </select>
			        </fieldset>
