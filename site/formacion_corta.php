	...
	<body>
		...
		<div id="container" style="background-color: #fff;">
			...
			<div class="col-sm-12" style="padding: 0px;">
				<img src="img/astro2019_cursocorto.jpg" width="100%">	
			</div>
							...
							<div class="col-xs-12 col-md-9" style="padding-left: 0px;">
								<div class="harmonic-styles astro">
										...
										<div class="col-12 col-md-6 col-lg-6"">
											<div class="video-container">
												<div class="video-responsive">
													<iframe width="565" height="300" src="https://www.youtube.com/embed/HhXX9DR8KSM" frameborder="0" allowfullscreen></iframe>
												</div>
											</div>
										</div>
										<div class="col-12 col-md-6 col-lg-6" style="padding: 0px; text-align: justify;">
											<h1><strong>CURSOS Y CARRERA DE ASTROLOGÍA</strong></h1>
										<hr style="margin: 5px; margin-bottom: 10px; margin-right: 40px;">
											<p style="font-size: 16px; margin-bottom: 5px; line-height: 25px; margin-right: 40px; margin-top: 20px;">Nuestros cursos de Astrología te darán las herramientas tanto para usar esta ciencia a nivel personal como con los demás. Tenemos dos modalidades, Curso o Carrera. Al finalizar un módulo podés continuar con el módulo en el siguiente nivel. Los módulos cuentan como crédito para la modalidad de la <a target="_blank" href="http://www.centroastrologico.com.ar/formacion_anual.php" style="font-size: 15px;">Carrera</a></p>
										</div>
									</div>
									

									<div>
									<h5 style="text-align: center; background-color: #F7EEF7; border-radius: 2px;" class="col-xs-12">CURSO POR MÓDULOS</h5>
									</div>
                                    ...
                                    <ul style="font-size: 15px;">
										...
										<li style="margin-bottom: 8px;"><b>Salud:</b> Incrementar tu vitalidad y mejorar la relación con tu cuerpo utilizando las energías inscriptas en tu carta natal. Desarrollá un programa integral de salud hecho a tu medida.</li>
									</ul>
									</div>
									...
									<div class="col-xs-12">
										<div>
									<h5 style="text-align: center; background-color: #F7EEF7; border-radius: 2px;" class="col-xs-12">MODALIDAD DE CURSADA</h5>
									</div>
										<hr style="margin: 8px; margin-bottom: 10px;">
										<br>
										<div class="row">
			                              <div class="col-md-6">
											<p style="margin-bottom: 0px; font-size: 15px;"><strong></strong></p>
											<ul style="font-size: 15px;">
											<li><strong>Turno Mañana:</strong> Jueves 7/3 a las 10:30 hs.</ol>
											<li><strong>Turno Tarde:</strong> Jueves 7/3 a las 19 hs.</li>
											</ul>
										</div>
			                              ...
			                              <div class="col-md-6">
											...
											<br>
											<strong>Precio:</strong> $2200
											<br>
											<strong>Consultar por Matrícula bonificada.</strong></p>
										</div>
										<div><p><strong>*Las inscripciones a los cursos se realizan mediante entrevista presencial.</strong>
										<br>
										<strong>*Todo esto cuenta para los que quieran después continuar con la carrera.</strong></p>
                                ...
                                <div>
									<h5>Programa:</h5>
									<p style="font-size: 15px;">Cada módulo dura un mes (1 clase semanal).</p>
