<div class="contact">
    <div>
        <form id="contact" action="contacto_libro.php" method="post">
            <h3 style="margin-bottom: 24px; color: #fff; font-weight: bold;">Request more information</h3>
            <fieldset>
            ...
            <fieldset>
                <textarea name="comment" placeholder="Write your message..." tabindex="6" required style="border:none; border-radius: 0px;"></textarea>
            </fieldset>
