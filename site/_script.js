...
// start -> ../sources/app/view/popup.js **************************************************
app.view.Popup = app.View.extend({
	...
	loadCineclub : function(){		
		$( this.el).load( "popup/load.php?file=cineclub",function(){
			$('#cineclubModal').modal();			
			$('#cineclubModal').on('shown.bs.modal', function (e) {					
				$(window).resize();//para el video
				 $('#cineclubModal').animate({ scrollTop: 0 }, 'slow');
			});
		});			
	},
	loadEvento : function(){		
		$( this.el).load( "popup/load.php?file=evento",function(){
			$('#eventoModal').modal();
			$('#eventoModal').animate({ scrollTop: 0 }, 'slow');
		});		
	},
	loadCineclubMensual : function(){		
		$( this.el).load( "popup/load.php?file=cineclubMensual",function(){
			$('#cineclubMensualModal').modal();
			$('#cineclubMensualModal').on('shown.bs.modal', function (e) {					
				$(window).resize();//para el video
				$('#cineclubMensualModal').animate({ scrollTop: 0 }, 'slow');
			});
		});	
	}
...
app.view.sections.Contacto = app.Section.extend({
	...
	initialize: function(){
		...
		ui.find("form").validate({
	        ...
	        messages: {
	        	inputName: "Debes ingresar tu nombre",
	        	inputEmail: "Debes ingresar tu email"
	        },
	...
	onResponse:function(){
		...
		if(response != 0){
 		   if(this.isNews)this.newsOk.show();
 		   else this.consultaOk.show();
 	   }
...
// start -> ../sources/app/model/popupModel.js **************************************************
app.data.models.popupModel = app.models.SectionModel.extend({
		name:'popupModel',
		idioma:null,
		popup:null,
	    load : function(){
...
// end -> ../sources/app/model/popupModel.js **************************************************
...
app.data.models.siteModel = app.models.HashModel.extend({
    	...
    	hashChange: function(section,route,params){
    		...
    		if(section && section.showContent==1)
    		{
    			self.url.app.getArticles({idSection:section.id},function(data){
