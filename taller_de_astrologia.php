					...
					<div class="container-fluid">
						<div class="row">
							<div class="col-md-9" style="padding: 0px;">
								<section class="article_section" style="padding-right: 80px; padding-bottom: 20px;">
                       <h2 id="top" class="articulo_text_header titulo-mobile" style="font-size: 22px; font-weight: 700; margin-bottom: 0; margin-top: 0px; text-transform: uppercase;">El Alfabeto Astrológico</h2>
								
                        <p  style="font-size: 18px; padding: 0px; margin-top: 5px;">-Taller de un Mes-</p>
                      ...
                      <div class="video-container">
                        ...
                        <iframe width="565" height="300" src="https://www.youtube.com/embed/eb904vgYf5c" frameborder="0" gesture="media" allow="encrypted-media" allowfullscreen></iframe>
                        </div>
                  	  </div>
						<br>
						...
						<p style="font-size: 15px; margin-bottom: 0; margin-top: -15px"><strong>INICIO: ABRIL.</strong><br>Turno Tarde:</p>
						<ul style="margin-bottom: 10px; list-style-position: inside;">
							<li style="font-size: 14px;margin-bottom: 10px;">Martes 9 de Abril, 19 hs.</li>
						</ul>
						<p style="font-size: 16px; margin-bottom: 0;">Turno Mañana:</p>
						<ul style="margin-bottom: 10px; list-style-position: inside;">
							<li style="font-size: 14px;">Jueves 11 de Abril, 10:30 hs.</li>
						</ul>
						...
						<p style="font-size: 14px; margin-bottom: 0;">
							<strong>Precio: </strong>$2200.</p>
						<p style="font-size: 12px; margin-bottom: 0;">
							<strong>Las inscripciones a los cursos se realizan mediante entrevista presencial.</strong></p>  
					
                    <hr>
            <h4 class="h2sub" style="margin-bottom: 5px; margin-top: 0px; font-size: 18px !important;">TEMARIO:<br><br>
                    ...
                    <ul class="font18" style="font-size: 17px;">
                      ...
                      <li>Salud: incrementar tu vitalidad y mejorar la relación con tu cuerpo utilizando las energías inscriptas en tu carta natal. Desarrollá un programa integral de salud hecho a tu medida.</li>
								...
								<div style="display: flex;" class="mobile-visibility-none hidden-xs hidden-s">
									<a href="#top" class="button solicita_btn" style=" margin: 0 auto; font-size: 16px;">SOLICITÁ MÁS INFORMACIÓN AQUÍ</a>
								</div>
					    </div>
