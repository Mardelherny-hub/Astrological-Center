...
class Index extends AppSerializableController {
  ...
  public function onLoad() {
	...
	if($newsletter==1)$message .= '<h2 style="margin:0px;padding-top:20px;">SUSCRIPCION AL NEWSLETTER DE ASTROLOGÍA</h2>';
	else $message .= '<h2 style="margin:0px;padding-top:20px;">CONSULTAS DESDE LA WEB DE ASTROLOGÍA</h2>';
