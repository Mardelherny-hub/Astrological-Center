...
class GET_eventos extends DA_Abs{
	...
	public static function setEvento($params){		
			...
			if(isset($params['idEvento'])){
				...
				$sql = "INSERT INTO eventos (tipoEvento_idTipo,fecha,date,titulo,subtitulo,fechaStr,horario,maxHorario,idYoutube,texto,lugares,lugar_idLugar,activo,mostrarHome,mostrarAstro,mostrarPsico)
					VALUES ('$tipo',now(),'$date','$titulo','$subtitulo','$fechaStr','$horario','$maxHorario','$idYoutube','$texto','$disponibilidad','$lugar','$activo','$mostrarHome','$mostrarAstro','$mostrarPsico');";	
			}
