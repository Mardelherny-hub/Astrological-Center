...
<html lang="es">
	<head>
		<?php include('site/head.php'); $asunto = 'Solicitud de Información - Guía Práctica de Astrología'; ?>
		<style>
	...
	<body>
		...
		<div id="container" style="background-color: #fff;">
			...
			<div class="row">
				<div class="col-sm-12">
					<iframe width="100%" height="550" class="video-header"
						...
						<div class="row">
							<div class="col-md-8" style="left: 20px; padding-right: 40px;">
								<section class="article_section">
									<h3>PRESENTAMOS NUESTRO NUEVO LIBRO</h3><br>
									<h2 style="margin-top: 0px; margin-bottom: 0px;">Guía Práctica de Astrología</h2>
									<p style="font-size: 24px;">Por la Astróloga Florencia Santoni</p>
									<p style="font-size: 20px;
										padding: 0px;">El Centro Astrológico Aztlan presenta el libro "Guía Práctica de Astrología", escrito por la Astróloga Florencia Santoni. </p>
									...
									<div class="page-header articulo_header" style="margin-bottom: 0px; border-bottom-width: 0px;
										...
										<div class="page-header articulo_header">
                                           ...
                                           <p style="font-size: 14px;"><i>www.centroastrologico.com.ar</i></p>
