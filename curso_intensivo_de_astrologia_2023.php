...
<body>
	...
	<div id="container" style="background-color: #fff;">
		...
		<div class="col-sm-12" style="padding: 0px;">
			<img src="https://centroastrologico.com.ar/assets/images/curso-astrologia-2023.jpg" width="100%">
		</div>
						...
						<div class="col-xs-12 col-md-9 col-lg-8" style="margin-bottom: 0px;">
							<div class="harmonic-styles astro">
								<div class="header-section" style="margin-bottom: 10px;">
									...
									<h4 style="font-size:17px;"> <b>Start:</b> Thursday, June 1st at 1 pm (Argentine Time)</h4>
    ...
    <ul class="font18" style="margin: 0px; padding-left: 16px; font-size: 16px; line-height: 26px;">
        <li>Zodiac Signs: Psychology and Physical Correspondence of each of the 12 zodiac archetypes.</li>
        <li>Planets: Understanding planets in an Astrological sense. Their significance on the Psychological and Physical planes.</li>
    </ul>
</div>
