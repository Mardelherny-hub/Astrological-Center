				...
				<div class="container-fluid">
					<div class="row">
						<div class="col-md-9">
							...
							<h4 class="subsection_title" style="border-top: 1px solid #ccc; font-size: 3em;">Other Recommended Videos:</h4>
								...
								<section class="recomended_videos" style="overflow: hidden; margin: 0px 30px;">
									<a href="video.php?videoid=k0gEKoGrUs4">
										<article class="video" style="float: left; width: 30%;">
											...
											<h5>Your Ideal Profession According to Your Sign</h5>
										</article>
									</a>
									<a href="video.php?videoid=03oePxDncgw">
										<article class="video" style="float: left; margin-left: 5%; margin-right: 5%; width: 30%;">
											...
											<h5>Fears According to Your Zodiac Sign</h5>
										</article>
									</a>
									<a href="video.php?videoid=y_EWAP_OHZI">
										<article class="video" style="float: left; width: 30%;">
											...
											<h5>Astrology: The Science of Energies</h5>
										</article>
									</a>
								</section>
							</section>
						...
						<div class="col-md-3 side_section">
							...
							<h5 style="font-size: 2em; font-weight: 700; margin: 1em 0px 0px 0px; text-align: center;">FOLLOW US ON:</h5>
