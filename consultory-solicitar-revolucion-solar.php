                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <br-->
                                    ...
                                    <ul style="margin-bottom: 10px; list-style-position: inside;">
                                        <li style="font-size: 14px;margin-bottom: 10px;">1-hour interview + 20-page report and drawing of your Natal and Solar Return Charts.</li>
                                    </ul>
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12 col-md-6">
                                            <p style="margin-bottom: 1px;  background-color: #f7efef"><strong>Astrology for Your Business</strong></p>
                            ...
                            <iframe style="width: 100%;min-height: 250px" src="https://www.youtube.com/embed/TSUTs0PPmcg" frameborder="0" allowfullscreen=""></iframe>
                                        ...
                                        <div class="col-md-6 col-xs-12">
                                            <h3 class="h2sub" style="margin-bottom: 10px; margin-top: 15px; font-size: 18px;"><b>What is the Solar Return?</b></h3>
                                            <hr style="margin-top: 10px; margin-bottom: 10px;">
                                    ...
                                    <div class="contacto" style="border-radius: 12px; margin: 0px;">
                                        <div>
                                            <form id="contact" action="gracias.php" method="post">
                                                <h3 style="color:white;">Ask for Your Solar Revolution</h3>
                                                <fieldset>
                                                    <input name="nombre" placeholder="Name and Surname" type="text" tabindex="1" required autofocus>
                                                </fieldset>
                                                <fieldset>
                                                    <input name="email" placeholder="Email" type="email" tabindex="2" required>
                                                </fieldset>
                                                <fieldset>
                                                    <input name="cel" placeholder="Phone" type="tel" tabindex="3" required>
                                                </fieldset>
                                                <fieldset>
                                                    <input name="fecha" placeholder="Date and time of birth" type="text" tabindex="4" required autofocus>
                                                </fieldset>
                                            ...
                                            <input name="facebook" placeholder="Facebook" type="text" tabindex="4" required>
                                                ...
                                                <fieldset>
                                                    <input name="ciudad" placeholder="City of birth" type="text" tabindex="6" required autofocus>
                                                </fieldset>

                                                <fieldset>
                                                    <input name="red" placeholder="Social Media" type="text" tabindex="7" required autofocus>
                                                </fieldset>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-sm-6" style="padding: 0px;">
                                                ...
                                                <fieldset>
                                                    <textarea name="comentario" placeholder="Write your message..." tabindex="8" required></textarea>
                                                </fieldset>
