                ...
                <section class="main_section">
                    <div class="container-fluid">
                      ...
                      <div class="video-container">
                        ...
                        <p style="font-size: 17px; margin-bottom: 0; margin-top: -15px"><strong>PEDÍ TU CARTA ASTRAL, REVOLUCIÓN SOLAR Y OTROS.</strong></p>
                            <hr style="margin: 0px 0px 2px 0px;">
                            <br>
                            <p style="margin-bottom: 1px; background-color: #f7efef"><strong>Carta Natal</strong></p>
                        <ul style="margin-bottom: 10px; list-style-position: inside;">
                            <li style="font-size: 14px;margin-bottom: 10px;">Entrevista de 1 hora + informe de 20 páginas y dibujo de tu carta. </li>
                        </ul>

                        <p style="margin-bottom: 1px;  background-color: #f7efef"><strong>Revolución Solar</strong></p>
                        <ul style="margin-bottom: 10px; list-style-position: inside;">
                            <li style="font-size: 14px;margin-bottom: 10px;">Entrevista de 1 hora + informe de 20 páginas y dibujo de tu Carta y Revolución Solar. </li>
                        </ul>

                        <p style="margin-bottom: 1px;  background-color: #f7efef"><strong>Sinastría</strong></p>
                        <ul style="margin-bottom: 10px; list-style-position: inside;">
                            <li style="font-size: 14px;margin-bottom: 10px;">3 entrevistas de 1 hora + 3 informes de 20 páginas y dibujos de las dos cartas natales. </li>
                        </ul>
                        <br><br><br>
                    ...
                    <div class="row" style="margin-bottom:50px;">
                        ...
                        <div class="col-md-6 col-xs-12">
                            <h3 class="h2sub" style="margin-bottom: 10px; margin-top: 15px; font-size: 18px;"><b>¿Qué es la Revolución Solar?</b></h3>
                            <hr style="margin-top: 10px; margin-bottom: 10px;">
                            ...
                            <div class="contacto" style="border-radius: 12px; margin: 0px;">
                                <div>
                                    <form id="contact" action="gracias.php" method="post">
                                        <h3 style="color:white;">Solicitá tu Revolución Solar</h3>
                                        <fieldset>
                                        ...
                                        <fieldset>
                                            <input name="fecha" placeholder="Fecha y hora de nacimiento" type="text" tabindex="4" required autofocus>
                                        </fieldset>
                                        <!--fieldset style="margin-bottom: 5px;">
                                            <input name="facebook" placeholder="Facebook" type="text" tabindex="4" required>
                                        </fieldset-->
                                        <fieldset>
                                            <select style="width: 100%; font-size: 18px; color: #000000;  border-radius: 5px; padding: 10px 0px 10px 6px; "name="pais" placeholder="Facebook" tabindex="5" required> <option value="Elegir" id="contact">Selecciona tu País</option>
...
<option value="Zimbabwe">Zimbabwe</option>
                                        ...
                                        <fieldset>
                                            <input name="ciudad" placeholder="Ciudad de nacimiento" type="text" tabindex="6" required autofocus>
                                        </fieldset>

                                        <fieldset>
                                            <input name="red" placeholder="Red social" type="text" tabindex="7" required autofocus>
                                        </fieldset>
                                        ...
                                        <input type="hidden" name="solicita" value="Revolución Solar">
                                        <fieldset>
                                            <textarea name="comentario" placeholder="Escribe tu mensaje..." tabindex="8" required></textarea>
                                        </fieldset>
