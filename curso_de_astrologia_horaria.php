...
<html lang="es">
	<head>
		<?php include('site/head.php'); $asunto = 'Solicitud de Información - Curso de Astrología Horaria'; ?>
                ...
                <div class="col-xs-12 col-md-9 col-lg-8" style="margin-bottom: 0px;">
                  <div class="harmonic-styles astro">
                    <div class="header-section" style="margin-bottom: 10px;">
                      ...
                      <h4 style="font-size:17px;"> <b>Inicio:</b> Sábado 17 de Septiembre a las 13 hs. (Hora Arg.)</h4>
                    ...
                    <!-- Contenido -->
                      ...
                      <div style="margin-top: 0px; margin-top: 30px;" class="col-xs-12 col-md-6">
                        <div class="iframe-global-responsive-container cancel-width">
                          <div class="iframe-container">
                            <iframe src="https://www.youtube.com/embed/PxSPiqNqLHs" frameborder="0" allowfullscreen></iframe>
                          </div>
                        </div>
                      </div>
                      ...
                      <div style="margin-top: 0px; margin-top: 0px;" class="col-xs-12 col-md-6">
