                ...
                <div class="col-xs-12 col-md-9 col-lg-8" style="margin-bottom: 0px;">
                  <div class="harmonic-styles astro">
                    <div class="header-section" style="margin-bottom: 10px;">
                      ...
                      <h4 style="font-size:17px;"> <b>Inicio:</b> Miércoles 04/01 a las 12 hs. (Hora Arg.)</h4>
                    </div>
                    ...
                    <div class="row">
                      <div class="col-xs-12 col-sm-12">            
                        <div class="col-xs-12 col-sm-12">
                          ...
                          <strong>Modalidad:</strong> Una clase por semana de 1 hora. Clases en vivo y disponibles por 72 hs.
